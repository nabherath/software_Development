...
if(isset($_POST['id'])) {
    ...
    $query = "UPDATE property SET AR='REQUEST' WHERE pid='$propertyId'";
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-8">
                        ...
                        <?php 
							$query=mysqli_query($con,"SELECT * FROM `property` Where isApprove='APPROVED'");
                                ...
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            ...
                                            <button data-id="<?php echo $row['pid'];?>" class="btn btn-success approveBtn">Reserve Now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            <?php 
                            $query=mysqli_query($con,"SELECT * FROM `property` WHERE isFeatured = 1 AND isApprove='APPROVED' ORDER BY date DESC LIMIT 3");
                                    while($row=mysqli_fetch_array($query))
                                    {
                            ?>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								<?php 
								$query=mysqli_query($con,"SELECT * FROM `property` Where isApprove='APPROVED' ORDER BY date DESC LIMIT 6");
										while($row=mysqli_fetch_array($query))
										{
								?>
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
...
<script>
    ...
    $('.approveBtn').click(function() {
        ...
        $.ajax({
            url: 'property.php', // Path to your PHP script
            type: 'POST',
            data: {id: propertyId},
            success: function(response) {
                // Handle success (e.g., show a message, update the button state)
                alert("Property request to Reserved !");
            },
