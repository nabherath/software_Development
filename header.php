  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/NSBM.JPG" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/NSBM.JPG" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="../warden/register.php"> Add user </a></li>
									<li><a href="adminlist.php"> Admin </a></li>
									<li><a href="userlist.php"> Student(User) </a></li>
									<li><a href="useragent.php"> Warden </a></li>
									<li><a href="userbuilder.php"> LandLoarder </a></li>
								</ul>
							</li>
