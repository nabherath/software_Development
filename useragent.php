            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Warden</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active">Warden</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Warden List</h4>
									<?php 
										if(isset($_GET['msg']))	
										echo $_GET['msg'];	
									?>
								...
								<div class="card-body">
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											<?php
												...
												$query=mysqli_query($con,"select * from user where utype='Warden'");
												$cnt=1;
